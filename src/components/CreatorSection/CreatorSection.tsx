    ...
    <div className={styles.creatorSection}>
      ...
      <div className={styles.textContainer}>
        ...
        <div className={styles.subtitleWrapper}>
          ...
          <p className={styles.subtitle}>Made with code, nostalgia & a little bit of fate ♥</p>
          <div className={styles.line}></div>
        </div>

        <div className={styles.buttonGroup}>
          <a 
            href="https://www.linkedin.com/in/adhigowda2006/" 
            target="_blank" 
          ...
          <a 
            href="https://github.com/adhiboss/" 
            target="_blank" 
            rel="noopener noreferrer"
      ...
      <div className={styles.imageContainer}>
        <img 
          src={deskSetup} 
          alt="Retro pixel art desk setup" 
